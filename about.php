...
<head>
	...
	<link rel="stylesheet" href="css/aboutstyle.css"> <!-- css -->
	<!-- <script src="scripts/aboutjs.js"></script> -->
    <!-- Modernizr -->
	<script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js" type="text/javascript"></script>
    <title>FAQ | Get-Knowledge</title>
		...
		<ul id="basics" class="cd-faq-group">
			...
			<li>
				...
				<div class="cd-faq-content">
					<p>You can change your password by going on "Login page" and click on the button "Forget password" , this will redirect you to forget page where you can change your password.</p><br>
					<p>Just enter your registered email address, mobile no. After entering this information just simply enter your "New Password" and confirm it. Now your password will be changed.</p>
				</div> <!-- cd-faq-content -->
			</li>
			...
			<li>
				...
				<div class="cd-faq-content">
					<p>To create an account in our youtube channel "Get-Knowledge" just click on the register now button which is at the end of the homepage. When you will click on it you will get "Registration page" opened just fill all the field over their.</p><br>
					<p>Remember one thing that your "Name will be only your username".</p>
				</div> <!-- cd-faq-content -->
			</li>
			...
			<li>
				...
				<div class="cd-faq-content">
					<p>If you want to delete a YouTube comment you left on a video, you just need to find the comment and make a few clicks.
						The process for deleting YouTube comments is the same whether you use a computer or a mobile device - you just need to be logged into the Google or YouTube account you used to leave the comment.</p>
				</div> <!-- cd-faq-content -->
			</li>
			...
			<li>
				...
				<div class="cd-faq-content">
					<p>Every single page on your website needs to be reviewed at least once a year. This means somebody who understands what each particular page is about needs to read it and check for errors or out of date information. If the thought of reviewing every page on your website annually is daunting, don’t panic! The benefit is that it often gets easier over time. So the first time you review your site, you may find a heap of inaccuracies and cringe-worthy errors. But once these are tidied-up, a quick and simple once-over is all that’s required to keep on top of content and ensure it stays current. <br>
					<p>There are two things to remember about reviewing your website. First, you don’t have to do it all in one day, and second, you don’t have to do it all by yourself. In fact, it’s best if you don’t!</p>
				</div> <!-- cd-faq-content -->
			</li>
		</ul> <!-- cd-faq-group -->
...
<script src="script/aboutjs.js"></script> <!-- Resource jQuery -->
</body>
</html>